---
title: Claude Code — Hooks reference (공식 원문)
source: Claude Code official documentation
source_url: https://code.claude.com/docs/en/hooks
fetched_from: https://code.claude.com/docs/en/hooks.md
updated_at: 2026-06-15T02:15:42Z
verbatim: true
processing: 요약 아님(원문 보존). 제거한 것만 — 문서 인덱스 블록쿼트, Mintlify "theme={null}" 코드펜스 cruft, MDX <div> 래퍼, 빈 앵커 태그(<span id/><a id/>). <img>는 ![alt](src) 마크다운으로 변환(내용 보존).
referenced_by: .claude/skills/multi-cli-hooks/SKILL.md
---
