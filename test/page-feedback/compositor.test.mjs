...
//
// Node 単体で実行: `node test/page-feedback/compositor.test.mjs`
...
import {
  ...
  legendLine,
  MAX_OUTPUT_DIM,
} from '../../lib/page-feedback/compositor.js';
...
test('compositor.js は foreignObject/SVG/Image を一切使わない（コメントは除外して走査）', () => {
  const raw = readFileSync(resolve(here, '../../lib/page-feedback/compositor.js'), 'utf8');
