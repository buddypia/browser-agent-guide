...
- X/Twitter(x.com/twitter.com)で「投稿を作る」「下書き」「draft」「画像を添付して投稿案」等を求められたら、
  draftXPost を使って投稿作成欄に下書きだけを入れる。Post/Tweet/ポスト/投稿ボタンはクリックしない。
  画像を添付する場合は imageUrl または imageDataUrl を draftXPost に渡す。画像生成そのものは、このページ操作動詞では行わない。
